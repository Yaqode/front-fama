...
function guardarProducto() {
    ...
    const subcategoriaId = document.getElementById('subcategoriaCombo').options[document.getElementById('subcategoriaCombo').selectedIndex].getAttribute('data-id');
    const submarcaId = document.getElementById('submarcaCombo').options[document.getElementById('submarcaCombo').selectedIndex].getAttribute('data-id');
