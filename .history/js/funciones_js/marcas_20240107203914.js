...
// Función para confirmar la eliminación de la marca
function confirmarEliminarMarca() {
    
    // Obtiene el ID de la marca del atributo data-id del botón "Eliminar"
    const idMarcaAEliminar = $('#btnConfirmarEliminarMarca').data('id');
    
    // Llama a la función eliminarMarca con el ID de la marca
