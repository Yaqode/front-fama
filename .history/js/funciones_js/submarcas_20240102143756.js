...
function mostrarSubmarcasEnTabla(submarcas) {
    ...
    marcas.forEach((marca) => {
        ...
        fila.insertCell(0).innerText = marca.subBrandId;
        fila.insertCell(1).innerText = marca.nameSubBrand;
        ...
        imagen.src = "data:image/jpeg;base64,"+marca.linkImageSubbrand;
        console.log("Ruta de la imagen:", marca.linkImageSubbrand); // Agrega un log para depurar
        imagen.alt = marca.nameSubBrand; 
