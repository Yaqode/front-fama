    ...
    function mostrarProductosEnTabla(productos) {
        ...
        productos.forEach((producto) => {
            ...
            fila.insertCell(10).innerText = producto.subbrand.nameSubBrand;
             ...
             var celdaImagen = fila.insertCell(11);
             var imagen = document.createElement("img");
             imagen.src = "data:image/jpeg;base64,"+producto.imageId;
             console.log("Ruta de la imagen:", producto.imageId); // Agrega un log para depurar
             imagen.alt = producto.nameProduct; 
