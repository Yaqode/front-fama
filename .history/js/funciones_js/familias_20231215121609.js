        ...
        .then(data => {
            ...
            data.forEach(subcategoria => {
                ...
                trigger.addEventListener('mouseover', () => {
                    // Aquí deberías cargar las categorías y subcategorías de la familia y mostrarlas
                    const categorias = obtenerCategoriasPorFamilia(subcategoria.category.family.familyId);
