...
function filtrarSubcategorias(terminoBusqueda) {
    // Obtener todas las opciones del select
    var opciones = $('#subcategoriaCombo option');

    // Filtrar las opciones basándose en el término de búsqueda
    opciones.each(function () {
        var textoOpcion = $(this).text().toLowerCase();
        var mostrar = textoOpcion.includes(terminoBusqueda.toLowerCase());
        $(this).toggle(mostrar);
    });
}