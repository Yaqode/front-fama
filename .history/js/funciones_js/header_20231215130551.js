...
async function cargarSubcategorias() {
    try {
        ...
        subcategorias.forEach(subcategoria => {
            ...
            // Agregar la subcategoría al menú de categoría
        ...
        // Añadir eventos para mostrar/ocultar los submenús
        const dropdownSubmenus = familiasMenu.querySelectorAll('.dropdown-submenu');
