...
obtenerListaProductos();
    ...
    function mostrarProductosEnTabla(productos) {
        ...
        productos.forEach((producto) => {
            ...
            // Agrega imágenes de la subcategoría si existen
            if (producto.subcategory.images) {
                producto.subcategory.images.forEach((imagen, index) => {
            ...
            // Agrega imágenes de la submarca si existen
            if (producto.subbrand.images) {
                producto.subbrand.images.forEach((imagen, index) => {
                    var img = document.createElement("img");
                    img.src = "data:image/jpeg;base64," + imagen;
                    img.alt = "Imagen " + (index + 1);
                    img.className = "imagen-thumbnail";
