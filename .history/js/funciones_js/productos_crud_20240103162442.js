function mostrarImagenesSeleccionadas() {
    ...
    // Crear un objeto FormData y agregar todos los archivos seleccionados
    var formData = new FormData(inputImagenes.form);

    // Iterar a través de todos los archivos seleccionados y mostrar miniaturas
    formData.getAll('fileInput').forEach(function (archivo, index) {
