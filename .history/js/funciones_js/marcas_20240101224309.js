...
function mostrarMarcasEnTabla(marcas) {
    ...
    marcas.forEach((marca) => {
        ...
        fila.insertCell(2).innerText = marca.linkImageBrand;
        ...
        imagen.alt = marca.nameBrand; // Agrega un texto alternativo para la imagen
        imagen.style.width = "50px"; // Puedes ajustar el tamaño según tus necesidades
