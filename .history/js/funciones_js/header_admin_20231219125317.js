...
document.addEventListener("DOMContentLoaded", function() {
    // Selecciona el submenú por su ID (asegúrate de agregar un ID a tu submenú)
    var subMenu = document.getElementById("tuSubMenuId");

    // Verifica si el submenú existe
    if (subMenu) {
        // Ajusta dinámicamente la altura del submenú
        subMenu.style.height = "500px"; // Puedes ajustar el valor según tus necesidades
    }
});