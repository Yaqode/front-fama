...
function guardarProducto() {
    ...
    const subcategoriaId = $('#subcategoriaCombo option:selected').data('id');

    // Obtener el id de la submarca seleccionada
    const submarcaId = $('#submarcaCombo option:selected').data('id');

    console.log('Subcategoría seleccionada (data-id):', subcategoriaId);
    console.log('Submarca seleccionada (data-id):', submarcaId);
