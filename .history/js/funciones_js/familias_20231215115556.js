...
function obtenerListaFamilias() {
    ...
    fetch('http://localhost:8090/fama-market/api/families/all')
        .then(response => response.json())
        .then(familias => {
            // Muestra las familias, categorías y subcategorías en el menú desplegable
            actualizarMenuDesplegable('familiasMenu', familias, 'Seleccionar familia', 'obtenerCategoriasYSubcategorias');
        })
        .catch(error => {
...
function obtenerCategoriasYSubcategorias(familiaId) {
    ...
    fetch(`http://localhost:8090/fama-market/api/categories-and-subcategories/byFamily/${familiaId}`)
        ...
        .then(categoriasYSubcategorias => {
            // Muestra categorías y subcategorías en el menú desplegable
            actualizarMenuDesplegable('familiasMenu', categoriasYSubcategorias, 'Seleccionar familia', null);
        })
        .catch(error => {
