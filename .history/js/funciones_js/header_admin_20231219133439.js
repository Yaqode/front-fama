...
function redirigir() {
    ...
    switch (opcionSeleccionada) {
      case "agregarFamilias":
        window.location.href = "ruta_para_agregar_familias.html";
        break;
      case "agregarCategorias":
        window.location.href = "ruta_para_agregar_categorias.html";
        break;
      case "agregarSubcategorias":
        window.location.href = "ruta_para_agregar_subcategorias.html";
        break;
      // Agrega más casos según sea necesario

      default:
        // No hacer nada si no se selecciona una opción válida
        break;
    }
  }