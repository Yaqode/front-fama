...
document.addEventListener('DOMContentLoaded', function () {
    // Otro código de inicialización o eventos si es necesario

    // Evento para manejar clics en botones de eliminar en la tabla
    document.addEventListener('click', function (event) {
        if (event.target.classList.contains('btn-eliminar-subcategoria')) {
            // Obtén el ID de la subcategoría desde algún atributo de la fila
            subcategoriaIdAEliminar = event.target.closest('tr').getAttribute('data-id-subcategoria');

            // Puedes mostrar el modal de eliminación aquí si es necesario
            // $('#modalEliminarSubcategorias').modal('show');
        }
    });
