...
obtenerListaProductos();
    ...
    function limpiarFormulario() {
        ...
        $('#subcategoriaCombo').val('').trigger('change'); // Limpiar y deseleccionar la subcategoría
        $('#submarcaCombo').val('').trigger('change'); // Limpiar y deseleccionar la submarca
    
        // Limpiar el campo de archivos
        $('#fileInput').val('');
        arrayImages = []; // Limpiar el array de imágenes
    }