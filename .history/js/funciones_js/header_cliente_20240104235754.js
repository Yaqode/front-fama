document.addEventListener("DOMContentLoaded", function () {
    ...
    function redirigirAProductos(marca) {
        // Aquí puedes construir la URL según tu estructura y redirigir
        // En este ejemplo, se redirige a la página de productos con el nombre de la marca como parámetro
        window.location.href = 'Views/productos.html?marca=' + encodeURIComponent(marca);
    }