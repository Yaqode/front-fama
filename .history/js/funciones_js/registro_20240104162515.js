function registrarPersona() {
    ...
    const nombre = document.getElementById('#nombre').val;
    const apellidoPaterno = document.getElementById('#apellidoPaterno').val();
    const apellidoMaterno = document.getElementById('#apellidoMaterno').val();
...
function registrarUsuario(personId) {
    ...
    const correo = document.getElementById('correo').valu;
