    ...
    .then((data) => {
      ...
      familiasMap.forEach((categoriasMap, familiaName) => {
        ...
        categoriasMap.forEach((subcategoriasArray, categoriaName) => {
            ...
            categoriaItem.appendChild(categoriaContent);
    
            // Ajustar el tamaño de las categorías (ajusta el valor según tus necesidades)
            categoriaContent.style.height = "250px"; // Modifica el tamaño aquí
            ...
            if (subcategoriasArray.length > 0) {
                ...
                subcategoriasList.style.height = "50px"; // Modifica el tamaño aquí
                ...
                subcategoriasArray.forEach((subcategoriaName) => {
                    ...
                    subcategoriaItem.appendChild(subcategoriaContent);
    
                    subcategoriaContent.style.height = "80px"; // Modifica el tamaño aquí
