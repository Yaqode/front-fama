...
===========================-->
        ...
        <!-- Segundo Modal -->
        <div class="modal fade" id="modalFamilia" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="top: calc(100% + 10px)">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        <!-- Tercer Modal -->
        <div class="modal fade" id="modalCategoria" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="top: calc(200% + 20px)">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
