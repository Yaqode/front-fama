...
<div class="container-xl">
    <div class="table-responsive">
        ...
        <button type="button" class="btn btn-success text-white mt-4 col-2 m-sm-3" data-bs-toggle="modal"
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    <tr>
                        ...
                        <td> <!-- Botones para editar y eliminar cada submarca -->
...
<script src="./../js/jquery-1.11.0.min.js"></scrip>
