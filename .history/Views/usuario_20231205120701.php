            ...
            <div class="modal-body">
                ...
                <form id="subcategoriaForm">
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="familiaSelect" required>
                            <option value="familia1">Familia 1</option>
                            <option value="familia2">Familia 2</option>
                            <!-- Agrega más opciones según sea necesario -->
                        </select>
                        <!-- Botón para abrir el segundo modal -->
                        <button type="button" class="btn btn-success" onclick="abrirSegundoModal()">Agregar Modal Familia</button>
                    </div>
                    <div class="mb-3">
                        ...
                        <button type="button" class="btn btn-success" onclick="abrirTercerModal()">Agregar Modal Categoría</button>
                    </div>
                    <div class="mb-3">
