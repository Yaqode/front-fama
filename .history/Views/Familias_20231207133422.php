...
<div class="modal fade" id="modalEliminarfamilia" tabindex="-1" role="dialog" aria-labelledby="modalEliminarfamiliaLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalEliminarSubmarcaLabel">Eliminar Familia</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
