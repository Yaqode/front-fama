...
<head>
    ...
    * {
    ...
    .carousel-inner img {
        width: 50%; /* Establece el ancho al 100% para que todas las imágenes ocupen el mismo ancho */
        height: auto; /* Mantiene la proporción original de la imagen */
    }

    #carouselExampleInterval {
        width: 50%; /* Ajusta el ancho del contenedor del carrusel según tus preferencias */
