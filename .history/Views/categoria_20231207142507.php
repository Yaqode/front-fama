...
<div class="container">
    <h2 class="mb-4">CRUD de categorias</h2>
    ...
    <!-- Tabla para mostrar la a categoria -->
    <table class="table">
        <thead>
            <tr>
                <th>ID</th>
                <th>Nombre</th>
                <th>Familia asociada</th>
                <th>Acciones</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td>Familia 1</td>
                <td>
                    <!-- Botones para editar y eliminar cada categoria -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="CategoriaForm">
                    <div class="mb-3">
                        <label for="categoriaInput" class="form-label">Nombre de la categoria:</label>
                        <input type="text" class="form-control" id="categoriaInput" required>
                    </div>
...
<div class="modal fade" id="modalEditarCategorias" tabindex="-1" role="dialog" aria-labelledby="modalEditarCategoriasLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <!-- Formulario para edtar categorias -->
                <form id="CategoriaForm">
                    <div class="mb-3">
                        <label for="categoriaInput" class="form-label">Nombre de la categoria:</label>
                        <input type="text" class="form-control" id="categoriaInput" required>
...
<div class="modal fade" id="modalEliminarCategorias" tabindex="-1" role="dialog" aria-labelledby="modalEliminarCategoriasLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalEliminarCategoriasLabel">Eliminar Categoria</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
