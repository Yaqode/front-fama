...
<body>
        ...
        <div class="row">
        <!-- Primera sección de perfil de dirección -->
        <div class="col-md-6">
            <div class="col-md-12">
            <!-- Botón para agregar dirección -->
            <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#modalAgregarDireccion">
                Agregar dirección
            </button>
        </div>
        ...
        <!-- Segunda sección de perfil de dirección -->
        <div class="col-md-6">
            <section class="seccion-perfil-usuario seccion-perfil-direccion">
                <div class="perfil-usuario-body">
                    <div class="perfil-usuario-footer">
