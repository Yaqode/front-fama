        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form>
                    ...
                    <div class="mb-3">
                        <label for="apellidoMaterno" class="form-label">Direccion:</label>
                        <input type="text" class="form-control" id="direccion" value="De la Cruz" required>
                    </div>
                    <div class="mb-3">
                        <label for="apellidoMaterno" class="form-label">Telefono:</label>
                        <input type="text" class="form-control" id="telefono" value="De la Cruz" required>
                    </div>
                    <div class="mb-3">
                        <label for="apellidoMaterno" class="form-label">Correo electronico:</label>
                        <input type="text" class="form-control" id="correoElectronico" value="De la Cruz" required>
                    </div>
                    <div class="mb-3">
                        <label for="apellidoMaterno" class="form-label">Usuario:</label>
                        <input type="text" class="form-control" id="usuario" value="De la Cruz" required>
                    </div>
                    <div class="mb-3">
                        <label for="apellidoMaterno" class="form-label">Usuario:</label>
                        <input type="text" class="form-control" id="usuario" value="De la Cruz" required>
