...
<table class="table mt-4">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>Submarca 1</td>
            <td>
                <!-- Contenedor para mostrar hasta 4 imágenes -->
                <div class="imagen-container">
                    <img src="ruta_de_la_imagen/imagen1.jpg" alt="Imagen 1" class="imagen-thumbnail">
                    <img src="ruta_de_la_imagen/imagen2.jpg" alt="Imagen 2" class="imagen-thumbnail">
                    <img src="ruta_de_la_imagen/imagen3.jpg" alt="Imagen 3" class="imagen-thumbnail">
                    <img src="ruta_de_la_imagen/imagen4.jpg" alt="Imagen 4" class="imagen-thumbnail">
                </div>
            </td>
            <td>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" class="form-control" id="imagenes" multiple accept="image/*"
                                        onchange="mostrarImagenesSeleccionadas()">
                                </div>
                                <!-- Contenedor para mostrar miniaturas de imágenes seleccionadas -->
                                ...
                                <button type="button" class="btn btn-primary" onclick="agregarCaracteristica()">Agregar
                                    Especificacion</button>
                            </div>
    ...
    <script src="./../js/funciones_js/productos_"></script>
