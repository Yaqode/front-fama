            ...
            <div class="modal-body">
                ...
                <form>
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="nombreProducto" class="form-label" style="border: 1px solid #343541;">Nombre del Producto:</label>
                                <input type="text" class="form-control" id="nombreProducto" required>
                            </div>
                            <div class="mb-3">
                                <label for="descripcion" class="form-label" style="border: 1px solid #343541;">Descripción:</label>
                                <textarea class="form-control" id="descripcion" rows="3"></textarea>
                            </div>
                            <!-- Otros campos del formulario también con bordes oscuros -->
                            <!-- ... -->
                            <div class="mb-3">
                                <label for="precio" class="form-label" style="border: 1px solid #343541;">Precio:</label>
                                <input type="text" class="form-control" id="precio" required>
                            </div>
                            <div class="mb-3">
                                <label for="precioDescuento" class="form-label" style="border: 1px solid #343541;">Precio con Descuento:</label>
                                <input type="text" class="form-control" id="precioDescuento">
                            </div>
                            <div class="mb-3">
                                <label for="codigoBarras" class="form-label" style="border: 1px solid #343541;">Código de Barras:</label>
                                <input type="text" class="form-control" id="codigoBarras">
                            </div>
                            <div class="mb-3">
                                <label for="codigoInterno" class="form-label" style="border: 1px solid #343541;">Código Interno:</label>
                                <input type="text" class="form-control" id="codigoInterno">
                            </div>
                            <div class="mb-3">
                                <label for="submarcaCombo" class="form-label" style="border: 1px solid #343541;">Submarca:</label>
                            ...
                            <div class="mb-3">
                                <label for="subcategoriaCombo" class="form-label" style="border: 1px solid #343541;">Subcategoría:</label>
