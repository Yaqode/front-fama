                ...
                <form>
                    <div class="row">
                        ...
                        <div class="col-md-6" style="border-right: 2px solid;">
                            ...
                            <img src="./../img/productos-icono.png" alt="Logo Imagen" onclick="alert('Agregar Imágenes')" style="cursor: pointer; width: 400px; height: 400px; border: 2px solid #000;">
                        </div>
                        <!-- Columna para los datos del producto -->
                        <div class="col-md-6">
                            <div class="mb-4" style="border: 2px solid #000;">
                                <label for="nombreProducto" class="form-label">Nombre del Producto:</label>
                                <input type="text" class="form-control" id="nombreProducto" required style="border: 1px solid #000;">
                            </div>
                            <!-- Otros campos del formulario también con bordes oscuros -->
                            <div class="mb-3" style="border: 2px solid #000;">
                                <label for="descripcion" class="form-label">Descripción:</label>
                                <textarea class="form-control" id="descripcion" rows="3" style="border: 1px solid #000;"></textarea>
                            </div>
                            <div class="mb-3" style="border: 2px solid #000;">
                                <label for="precio" class="form-label">Precio:</label>
                                <input type="text" class="form-control" id="precio" required style="border: 1px solid #000;">
                            </div>
                            <div class="mb-3" style="border: 2px solid #000;">
                                <label for="precioDescuento" class="form-label">Precio con Descuento:</label>
                                <input type="text" class="form-control" id="precioDescuento" style="border: 1px solid #000;">
                            </div>
                            <div class="mb-3" style="border: 2px solid #000;">
                                <label for="codigoBarras" class="form-label">Código de Barras:</label>
                                <input type="text" class="form-control" id="codigoBarras" style="border: 1px solid #000;">
                            </div>
                            <div class="mb-3" style="border: 2px solid #000;">
                                <label for="codigoInterno" class="form-label">Código Interno:</label>
                                <input type="text" class="form-control" id="codigoInterno" style="border: 1px solid #000;">
                            </div>
                            <div class="mb-3" style="border: 2px solid #000;">
                                <label for="submarcaCombo" class="form-label">Submarca:</label>
                                <select class="form-select" id="submarcaCombo" required style="border: 1px solid #000;">
                            ...
                            <div class="mb-3" style="border: 2px solid #000;">
                                ...
                                <select class="form-select" id="subcategoriaCombo" required style="border: 1px solid #000;">
