                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                     ...
                                     <!-- Tabla para registrar características -->
                            <div class="mb-3">
                                <label for="tablaCaracteristicas" class="form-label">Características:</label>
                                <table class="table table-bordered" id="tablaCaracteristicas">
                                    ...
                                    <tbody>
                                        <!-- Filas para las características -->
                                        <tr>
                                            <td><input type="text" class="form-control" name="nombreCaracteristica[]" required></td>
                                            <td><input type="text" class="form-control" name="descripcionCaracteristica[]" required></td>
                                        </tr>
                                        <!-- Puedes agregar más filas según sea necesario -->
                                    </tbody>
                                </table>
                                <!-- Botón para agregar nueva característica -->
                                <button type="button" class="btn btn-success" onclick="agregarCaracteristica()">Agregar Característica</button>
                            </div>
                                </div>
                            </div>
                        </form>
