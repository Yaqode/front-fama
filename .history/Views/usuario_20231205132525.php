...
===========================-->
        ...
        <div class="container d-flex align-items-center justify-content-center" style="height: auto;">
            <button type="button" class="btn bg-danger text-white mt-4" data-bs-toggle="modal" data-bs-target="#exampleModal">
                Agregar Subcategorias
            </button>
            <button type="button" class="btn btn-success text-white mt-4" data-bs-toggle="modal" data-bs-target="#modalSubmarca">
                Agregar Submarca
            </button>
        </div>
        <!-- Primer Modal -->
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="background-color: #EAF1EF; border: 1px solid #ddd; padding: 20px; border-radius: 8px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); max-width: 300px; width: 100%; text-align: center; transition: transform 0.3s ease-in-out;">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Agregar Submarca</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <!-- Contenido del formulario para agregar submarca -->
                <form>
                    <div class="mb-3">
                        <label for="marcaCombo" class="form-label">Marca:</label>
                        <select class="form-select" id="marcaCombo" required>
                            <!-- Aquí puedes agregar opciones para las marcas -->
                            <option value="marca1">Marca 1</option>
                            <option value="marca2">Marca 2</option>
                            <!-- Agrega más opciones según sea necesario -->
                        </select>
                        <button type="button" class="btn btn-primary ms-2" data-bs-toggle="modal" data-bs-target="#modalAgregarMarca">Agregar Marca</button>
                    </div>
                    <div class="mb-3">
                        <label for="submarcaNombre" class="form-label">Nombre de la Submarca:</label>
                        <input type="text" class="form-control" id="submarcaNombre" required>
                    </div>
