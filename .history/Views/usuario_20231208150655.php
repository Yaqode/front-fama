...
<body>
    ...
    <!-- Sección de perfil de dirección (primera columna) -->
    <div class="row">
        <div class="col-md-6">
                ...
                <div class="perfil-usuario-body">
                    <div class="perfil-usuario-footer">
                        <ul class="lista-datos">
                            ...
                            <!-- Otros elementos de dirección -->
                        </ul>
                        <!-- Botón más pequeño en altura para abrir el modal de edición -->
        ...
        <!-- Sección de perfil de dirección (segunda columna) -->
        <div class="col-md-6">
            <section class="seccion-perfil-usuario seccion-perfil-direccion">
                <div class="perfil-usuario-body">
                    <div class="perfil-usuario-footer">
